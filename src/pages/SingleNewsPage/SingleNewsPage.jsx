...
export const SingleNewsPage = () => {
  ...
  return (
    <TemplatePage>
      <main className={`container default-page ${styles.news__container}`}>
        ...
        <div className={styles.news__box}>
          ...
          <div className={styles.like__container}>
            ...
            {likes?.length > 1 ? (
              ...
              <p className="text-sm">Seja o primeiro a curtir este post</p>
            )}
          </div>
        ...
        <section className={styles.moreNews__container}>
          ...
          <ul className={styles.moreNews__list}>
            {moreNews.length > 0 ? (
              moreNews.map((news) => {
                return (
                  <li key={news.id} className={styles.moreNews__card}>
                    <div>
                      <img
                        className={styles.moreNews__listImage}
                        src={news.image}
                        alt="imagem"
                      />
              ...
              <p className="text">Não há mais posts no momento...</p>
            )}
          </ul>
        </section>
      </main>
